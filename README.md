...
| [docs/dua_references/](docs/dua_references/) | reviewer artefacts — every supplication on one page (`dua-sources.md`, `dua-full.md`, `dua-full.html`), next to its sunnah.com / quran.com link. Generators live alongside them; rebuild with `python3 docs/dua_references/build_dua_full.py` etc. |
